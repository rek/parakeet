        ...
        return [
          {
            ...
            rationale: 'Major injury — session skipped',
          },
        ];
      }
        ...
        return [
          {
            ...
            reduction_pct: 40,
            rationale:
              'Moderate injury — reduce intensity 40% to protect injured area',
          },
        ];
      }
      return [
        {
          ...
          reduction_pct: 20,
          rationale:
            'Minor injury — reduce intensity 20% to maintain movement pattern safely',
        },
      ];
        ...
        return [
          {
            session_id: sessionId,
            action: 'session_skipped',
            rationale: 'Major illness — session skipped for recovery',
          },
        ];
      }
      if (severity === 'moderate') {
        return [
          {
            ...
            action: 'weight_reduced',
            reduction_pct: 25,
            rationale: 'Moderate illness — reduce weight 25%',
          },
          {
            session_id: sessionId,
            action: 'reps_reduced',
            reps_reduction: 2,
            rationale: 'Moderate illness — reduce reps by 2 per set',
          },
        ];
      }
      return [
        {
          ...
          action: 'reps_reduced',
          reps_reduction: 2,
          rationale: 'Minor illness — reduce reps by 2 per set',
        },
      ];
        ...
        return [
          {
            session_id: sessionId,
            action: 'session_skipped',
            rationale: 'Major fatigue — session skipped',
          },
        ];
      }
      if (severity === 'moderate') {
        return [
          {
            ...
            action: 'weight_reduced',
            reduction_pct: 20,
            rationale: 'Moderate fatigue — reduce intensity 20%',
          },
        ];
      }
      ...
      return [
        {
          ...
          rationale:
            'Equipment unavailable — substitute with available alternatives',
