...
const NEUTRAL: CyclePhaseModifier = {
  ...
  switch (phase) {
    case 'menstrual':
      return {
        ...
        volumeModifier: -1,
        rationale: 'Menstrual phase — reduced intensity 5%, −1 set',
      };
    case 'follicular':
      return NEUTRAL;
    case 'ovulatory':
    ...
    case 'luteal':
      return {
        ...
        volumeModifier: 0,
        rationale: 'Luteal phase — reduced intensity 2.5%',
      };
    case 'late_luteal':
      return {
        intensityMultiplier: 0.95,
        volumeModifier: -1,
        rationale: 'Late luteal phase — reduced intensity 5%, −1 set',
      };
    default:
      return NEUTRAL;
  }
