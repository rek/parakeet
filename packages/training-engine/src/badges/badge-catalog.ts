...
export const BADGE_CATALOG: Record<BadgeId, BadgeDef> = {
  ...
  dawn_patrol: {
    ...
    flavor: 'For the psychopaths who train before sunrise',
    emoji: '🌅',
  ...
  night_owl: {
    ...
    flavor: 'The gym is empty and the vibes are unhinged',
    emoji: '🦉',
    category: 'consistency',
  },
  iron_monk: {
  ...
  sunday_scaries_cure: {
    ...
    flavor: 'Nothing fixes existential dread like deadlifts',
    emoji: '🫠',
    category: 'consistency',
  },
  year_365: {
