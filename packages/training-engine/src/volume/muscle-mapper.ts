...
export function getMusclesForLift(lift: Lift, exercise?: string): MuscleContribution[] {
  if (exercise) {
...
export function getMusclesForExercise(exerciseName: string): MuscleContribution[] {
