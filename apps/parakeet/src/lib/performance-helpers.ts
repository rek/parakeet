/**
 * Pure (no I/O) helpers for processing performance/history data.
 * Kept separate so Vitest can import without pulling in Supabase/React Native.
 */
...
// ── Internal shape matching the raw Supabase row ──────────────────────────────
...
export interface RawHistoryRow {
  ...
  sessions: unknown   // join shape varies; not needed for processing
}
