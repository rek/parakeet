...
type HasNonEmptyPublicTables<DB> = DB extends {
  public: { Tables: infer Tables };
}
...
type __SupabaseTypesMustBeGenerated = AssertTrue<
  HasNonEmptyPublicTables<SupabaseDatabase>
>;
...
export type DbRow<TTable extends DbTable> =
  Database['public']['Tables'][TTable]['Row'];
export type DbInsert<TTable extends DbTable> =
  Database['public']['Tables'][TTable]['Insert'];
export type DbUpdate<TTable extends DbTable> =
