...
export function getVolumeStatusColor(
  ...
  switch (status) {
    case 'below_mev':        return colors.info
    case 'in_range':         return colors.success
    case 'approaching_mrv':  return colors.warning
    case 'at_mrv':           return colors.danger
    case 'exceeded_mrv':     return colors.danger
