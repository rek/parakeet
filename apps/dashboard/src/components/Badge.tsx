...
export function statusBadge(status: string) {
  if (status === 'implemented')
    return <Badge label="Implemented" variant="green" />;
  if (status === 'acknowledged')
    return <Badge label="Acknowledged" variant="blue" />;
  if (status === 'dismissed')
    return <Badge label="Dismissed" variant="muted" />;
