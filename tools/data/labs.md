...
"talk to a clinician", not "adjust the dose yourself".
...
- Swelling 0–10 (subjective) + circumference measurements at standard
  landmarks (thigh mid, calf max, ankle, upper arm, wrist).
- Quality of life score (SF-12 or similar).
- Body weight + waist:hip ratio. **Do not use BMI in isolation** —
  lipedema fat is not ordinary fat, so BMI overstates adiposity.
- Bioimpedance body-fat reading is **unreliable** on lipedema limbs.
  DXA is the ground truth if accessible.
...
- **Vitamin E** — deficiency possible on very strict keto; worth a
  check at month 6.
- **Manganese** — low-availability under heavy-restriction patterns.
- **Urinary calcium** (if symptomatic: bone pain / kidney stones) —
  elevated excretion is the mechanism behind bone-loss risk.

## Medication / supplement interactions to flag

- **Warfarin** + Vitamin K2 MK-7: even low-dose K2 can shift INR.
  Never start K2 without telling the prescribing clinician.
- **Anticoagulants** + Diosmin (Daflon) / Butcher's Broom: theoretical
  additive bleeding risk.
- **Metformin** + Berberine: both lower glucose; combined hypoglycemia
  possible. Not a hard stop, but coordinate dosing with clinician.
- **Statins** + Magnesium: no direct interaction, but rhabdomyolysis
  symptoms (cramps) on statins look like magnesium deficiency and vice
  versa — keep the two stories separate.
- **Thyroid hormone replacement** + Calcium / Iron: these bind thyroid
  hormone in the gut. Space 4 hours apart.

## Pregnancy / breastfeeding

- Lipedema is hormonally triggered — pregnancy is a common onset and
  progression window.
- Ketogenic diet during pregnancy is **not routinely recommended** in
  guidelines; discuss with OB/GYN. Moderate low-carb (75–100g/day,
  Mediterranean-pattern) is more conservative.
- Supplements: Diosmin / Butcher's Broom / Berberine are generally not
  recommended in pregnancy. Vitamin D, B12, omega-3, magnesium, iron,
  choline, and folate **are** supported in pregnancy at standard
  prenatal doses.
...
- Routine home ketone testing past the first 8 weeks is low-value.
  Urine strips go negative as you become fat-adapted even when blood
  ketones are elevated.
- Daily weighing without symptom tracking — the scale is the least
  informative metric on a lipedema-focused diet.
...
- NIH Office of Dietary Supplements — reference ranges and upper
  ...
  [ods.od.nih.gov](https://ods.od.nih.gov/)
