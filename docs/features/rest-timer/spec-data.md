...
- [engine-020-rest-config.md](./spec-engine-config.md) — consumes overrides via JITInput
- [mobile-018-rest-timer-settings.md](./spec-settings.md) — writes overrides via setRestOverride
