...
- [engine-020-rest-config.md](./spec-engine-config.md) — `JITOutput.restRecommendations` source
- [engine-021-llm-rest-suggestions.md](./spec-llm-suggestions.md) — `llmRestSuggestion` field
