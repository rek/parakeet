...
@Takpapp's report captures the user experience: _"For two sessions in a row I've manually adjusted them. I would expect the program to look at my last successful lifts of that type to determine the weight."_
