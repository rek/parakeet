...
- [engine-029-fatigue-predictor.md](./spec-fatigue-predictor.md) — `FatigueMismatch` shape stored in `mismatches` JSONB
- [mobile-036-weekly-body-review.md](./spec-weekly-review.md) — primary consumer
