...
- [data-008-biometric-tables.md](./spec-biometric-data.md) — `session_logs` HR columns must exist
- [types-002-biometric-schemas.md](./spec-biometric-types.md) — `HrSampleSchema`, `SessionHrDataSchema`
