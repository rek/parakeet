...
- [data-008-biometric-tables.md](./spec-biometric-data.md) — tables must exist
- [types-002-biometric-schemas.md](./spec-biometric-types.md) — schemas for validation
- [engine-032-wearable-readiness-adjuster.md](./spec-readiness-adjuster.md) — engine must accept wearable JITInput fields
