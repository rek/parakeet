...
- Specs: [engine-006-mrv-mev-calculator.md](./spec-mrv-mev-calculator.md), [engine-007-jit-session-generator.md](../jit-pipeline/spec-generator.md), [engine-009-soreness-adjuster.md](../soreness-and-readiness/spec-soreness-adjuster.md), [parakeet-011-soreness-checkin-screen.md](../soreness-and-readiness/spec-checkin-screen.md), [parakeet-012-volume-dashboard.md](./spec-dashboard.md)
