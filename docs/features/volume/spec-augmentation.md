...
- [data-002-auxiliary-exercise-config.md](../auxiliary-exercises/spec-config.md) — muscle mapping + exercise type system (both implemented)
- Design: [jit-volume-augmentation.md](./design-augmentation.md)
