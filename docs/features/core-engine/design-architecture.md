...
- `modules/achievements/data/session.repository.ts` re-exports a sibling module's _private_ repository. Either consume the session module through its public API or copy the narrow function set with an inline justification.
...
- Specs: [engine-007-jit-session-generator.md](../jit-pipeline/spec-generator.md), [engine-005-performance-adjuster.md](./spec-performance-adjuster.md), [engine-011-llm-jit-generator.md](../jit-pipeline/spec-llm-strategy.md), [engine-023-hybrid-jit-generator.md](../jit-pipeline/spec-hybrid.md)
