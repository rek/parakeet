...
**Important:** Per `docs/design/volume-mrv-methodology.md`, warm-up sets do NOT count toward MRV (they are not hard sets). This spec is NOT about MRV — it's about capturing warm-up history for analytical purposes.
