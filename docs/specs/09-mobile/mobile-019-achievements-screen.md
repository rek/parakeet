...
- [engine-022-pr-detection.md](../04-engine/engine-022-pr-detection.md) — PR detection + streak + cycle completion logic
- [engine-013-wilks-formula.md](../04-engine/engine-013-wilks-formula.md) — WILKS score computation
