...
**`apps/mobile/components/program/WeekGrid.tsx`:**
- Renders the list of `WeekRow` components
- Accepts `program: Program` as prop

**`apps/mobile/components/program/WeekRow.tsx`:**
...
**`apps/mobile/components/program/BlockBadge.tsx`:**
...
**`apps/mobile/components/program/SessionSummary.tsx`:**
