...
- [engine-028-readiness-adjuster.md](../04-engine/engine-028-readiness-adjuster.md) — `getReadinessModifier` consumes `sleepQuality` / `energyLevel` from `JITInput`
- [mobile-011-soreness-checkin-screen.md](./mobile-011-soreness-checkin-screen.md) — base screen being extended
- [data-005-cycle-tracking.md](../05-data/data-005-cycle-tracking.md) — `getCurrentCycleContext` source
- [engine-007-jit-session-generator.md](../04-engine/engine-007-jit-session-generator.md) — `JITInput` type extended here
