...
Design doc: [llm-challenge-mode.md](../../design/llm-challenge-mode.md)
...
**`docs/design/llm-challenge-mode.md`:**
...
- [engine-007-jit-session-generator.md](../04-engine/engine-007-jit-session-generator.md) — JITInput, JITOutput types
- [engine-023-hybrid-jit-generator.md](../04-engine/engine-023-hybrid-jit-generator.md) — comparison logging pattern, fire-and-forget pattern
- [mobile-005-session-logging-screen.md](../09-mobile/mobile-005-session-logging-screen.md) — session screen where ChallengeBanner renders
