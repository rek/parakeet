...
- [infra-003-supabase-setup.md](../01-infra/infra-003-supabase-setup.md) — Supabase local + migration workflow
- [types-002-biometric-schemas.md](../03-types/types-002-biometric-schemas.md) — Zod schemas must align with table columns
