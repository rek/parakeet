...
- [x] `SessionSchema`: id, program_id, week_number, day_number, primary_lift, intensity_type, block_number, is_deload, planned_sets, status, planned_date
...
- [x] `AdjustmentSuggestionSchema`: session_id, action, reduction_pct (optional), rationale, substitution_note (optional)
