...
- Spec: [types-002-biometric-schemas.md](../specs/03-types/types-002-biometric-schemas.md)
- Spec: [data-008-biometric-tables.md](../specs/05-data/data-008-biometric-tables.md)
- Spec: [engine-032-wearable-readiness-adjuster.md](../specs/04-engine/engine-032-wearable-readiness-adjuster.md)
- Spec: [mobile-038-wearable-data-pipeline.md](../specs/09-mobile/mobile-038-wearable-data-pipeline.md)
- Spec: [mobile-039-recovery-card-ui.md](../specs/09-mobile/mobile-039-recovery-card-ui.md)
- Spec: [mobile-040-intra-session-hr.md](../specs/09-mobile/mobile-040-intra-session-hr.md)
