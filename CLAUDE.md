...
| [guide/migration-pattern.md](./docs/guide/migration-pattern.md)       | Coupled schema + app change |
| [guide/troubleshooting.md](./docs/guide/troubleshooting.md)           | Recurring bugs + fixes      |
