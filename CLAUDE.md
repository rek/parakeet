...
- We track work in spec files to track all work (in /docs/specs)
...
- Scope: `parakeet` (app-specific) or `shared` (cross-app)
...
nx g @nx/react-native:lib @parakeet/feature-name \
  --directory=libs/parakeet/feature-name \
